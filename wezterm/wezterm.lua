...
local onedark_colors, _ =
	wezterm.color.load_scheme((os.getenv("HOME") or os.getenv("UserProfile")) .. "/.config/wezterm/onedarkpro.toml")
...
if string.find(wezterm.target_triple, "windows") ~= nil then
	config.default_prog = {
		(os.getenv("SystemRoot") or "C:\\Windows\\") .. "\\System32\\WindowsPowerShell\\v1.0\\powershell.exe",
		"-NoLogo",
	}
